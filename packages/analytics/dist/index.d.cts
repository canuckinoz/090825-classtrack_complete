 ...
 */
declare function computeClassForecast(
  logs: BehaviourLog[],
  options?: ClassForecastOptions
): ClassForecastResult;
declare function computeStudentPrediction(
  student_id: UUID$1,
  behaviours: Array<{
    created_at: string | number | Date;
    behaviour_type: string;
...
declare function computeClassWeatherMetaphor(
  logs: BehaviourLog[],
  opts?: ClassForecastOptions
): string;
/** Helper: build hourly buckets (useful for charts); respects polarity lists */
declare function buildHourlyBuckets(
  logs: BehaviourLog[],
  positiveTypes?: string[],
  negativeTypes?: string[]
): Array<{
...
declare function computeABCClassInsights(
...
declare function computeABCStudentInsights(
  studentId: UUID,
  events: ABCEvent[],
  opts?: ABCOptions
): ABCStudentInsights;
...
export {
  ...
  StudentPredictionResult,
  FocusStudent$1 as WeatherFocusStudent,
  UUID$1 as WeatherUUID,
  buildHourlyBuckets,
